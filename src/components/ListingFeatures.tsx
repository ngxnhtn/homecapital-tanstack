...
export function ListingFeatures({ listing }: ListingFeaturesProps) {
  ...
  return (
    <div className="mb-12 border-t-4 border-gold-600 bg-white p-10 shadow-xl md:p-12">
      ...
      <div className="prose prose-lg max-w-none prose-stone prose-headings:font-serif prose-headings:font-medium prose-p:leading-relaxed prose-p:font-light prose-a:text-gold-600 prose-blockquote:border-gold-400 prose-blockquote:bg-stone-50 prose-blockquote:px-6 prose-blockquote:py-2 prose-blockquote:not-italic prose-li:marker:text-gold-500">
