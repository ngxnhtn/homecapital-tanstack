import { createImageUrlBuilder, type SanityImageSource } from "@sanity/image-url/signed";
import type { LocalesContextValue } from "../hooks/locales";
import { createServerFn } from "@tanstack/react-start";

const builder = createImageUrlBuilder({
  clientConfig: { dataset: process.env.SANITY_DATASET, projectId: process.env.SANITY_PROJECT_ID },
});
...
const convertLocalesFormat = (i18nArray: InternationalArray): ConvertedI18nFormat => {
